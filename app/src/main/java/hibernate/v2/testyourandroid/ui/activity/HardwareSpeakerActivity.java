...
public class HardwareSpeakerActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_speaker);
		...
		Fragment fragment = new HardwareSpeakerFragment();
