...
class MainActivity : BaseActivity(), RatingDialogListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val installerPackageName = packageManager.getInstallerPackageName(AppUtils.getAppPackageName())
        ...
        fragmentManager.beginTransaction()
                ...
                .commit()
        countRate()
        if ("SHORTCUT_LAUNCH" == intent.action) {
            val bundle = Bundle()
            bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, intent.dataString)
    ...
    fun openDialogLanguage() {
        MaterialDialog(this)
                ...
                .listItemsSingleChoice(R.array.language_choose, waitForPositiveButton = false) { dialog, index, text ->
                    dialog.dismiss()
