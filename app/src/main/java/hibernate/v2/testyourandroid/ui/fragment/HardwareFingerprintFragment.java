 ...
 */
public class HardwareFingerprintFragment extends BaseFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_hardware_fingerprint, container, false);
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			if (fingerprintManager == null) {
				...
				try {
					...
					fingerprintHandler = new FingerprintHandler(mContext, helpText);
