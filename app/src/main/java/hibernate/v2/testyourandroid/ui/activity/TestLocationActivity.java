...
import hibernate.v2.testyourandroid.ui.fragment.TestLocationFragment;
...
public class TestLocationActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_test_gps);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = new TestLocationFragment();
