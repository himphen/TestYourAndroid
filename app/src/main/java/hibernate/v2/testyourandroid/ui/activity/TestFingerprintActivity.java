...
import hibernate.v2.testyourandroid.ui.fragment.TestFingerprintFragment;
...
public class TestFingerprintActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_test_fingerprint);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			...
			Fragment fragment = new TestFingerprintFragment();
