...
public class HardwareNFCActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_nfc);
		...
		Fragment fragment = new HardwareNFCFragment();
