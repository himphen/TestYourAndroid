...
public class HardwareMicrophoneActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_microphone);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = new HardwareMicrophoneFragment();
