...
public class ToolSoundMeterActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_sound_meter);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = ToolSoundMeterFragment.newInstance();
