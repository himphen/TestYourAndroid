...
class AppItemAdapter(
        private val mDataList: List<AppItem>,
        private val mListener: ItemClickListener
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    interface ItemClickListener {
        fun onItemDetailClick(catChoice: AppItem?)
    }
    ...
    override fun onBindViewHolder(rawHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.rootView.setOnClickListener { view -> mListener.onItemDetailClick(view.tag as AppItem) }
    }
