...
public class HardwareTouchActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_touch);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = new HardwareTouchFragment();
