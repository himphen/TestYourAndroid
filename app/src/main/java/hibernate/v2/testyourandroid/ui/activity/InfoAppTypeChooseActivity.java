...
public class InfoAppTypeChooseActivity extends BaseActivity {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		initActionBar(getSupportActionBar(), R.string.title_activity_app_choose);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = new AppChooseFragment();
